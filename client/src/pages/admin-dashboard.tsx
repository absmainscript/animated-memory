...
import type { SiteConfig, Testimonial, FaqItem, Service, Specialty } from "@shared/schema";
import {
  DndContext,
  closestCenter,
  KeyboardSensor,
...
export default function AdminDashboard() {
  ...
  const { data: photoCarousel = [] } = useQuery<any[]>({
  ...
  const ResponsiveCard = ({ children, className = "", ...props }: any) => (
    <Card className={`
      ...
      hover:shadow-md transition-all duration-200 rounded-2xl
      overflow-hidden
      ${className}
    `} {...props}>
      {children}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-purple-50">
      ...
      {/* Main Content */}
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-8 pb-24 lg:pb-8">
        {/* Welcome Banner */}
        {showWelcomeBanner && (
          <motion.div
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
              ...
              <div className="mb-6">
                <Select value={activeTab} onValueChange={setActiveTab}>
                  <SelectTrigger className="w-full bg-white/95 backdrop-blur-sm border border-gray-200 rounded-2xl p-4 h-auto shadow-sm hover:shadow-md transition-all duration-200 touch-manipulation">
              ...
              <TabsContent value="gallery" className="space-y-6">
                ...
                <ResponsiveCard>
                  ...
                  <CardContent>
                    <PhotoCarouselManager configs={photoCarousel} />
                  </CardContent>
                </ResponsiveCard>
              </TabsContent>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-t border-gray-200 shadow-lg safe-area-bottom">
        <div className="flex justify-center py-2 px-4">
          <div className="flex items-center gap-2 px-3 py-1 bg-gradient-to-r from-purple-100 to-pink-100 rounded-full">
            ...
            <span className="text-xs text-purple-700 font-medium">Painel Administrativo</span>
          </div>
        </div>
      </div>
    </div>
